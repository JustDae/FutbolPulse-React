...
interface PremiumPlayerDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export const PremiumPlayerDialog = ({ isOpen, onClose, playerToEdit, defaultTeamId }: PremiumPlayerDialogProps) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="mt-6 flex justify-end gap-3 border-t border-[#2D3748] pt-4">
                <button
                  type="button"
                  onClick={onClose}
                  className="rounded-xl bg-[#2D3748] px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#3f4a5c] transition-colors cursor-pointer"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="rounded-xl bg-[#E63946] px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#c42838] transition-colors disabled:opacity-50 cursor-pointer"
                >
