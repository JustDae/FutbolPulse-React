    ...
    <div className="w-full min-h-[calc(100vh-4rem)] pb-20 text-slate-800" style={{ background: OFF_WHITE, fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-12 grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-12">
        {teams.map((team) => (
          ...
          >
            {}
            <div className="h-28 flex items-center justify-center border-b border-slate-100 bg-slate-50/50">
              <div
                className="w-24 aspect-[3/2] flex items-center justify-center border border-slate-200 overflow-hidden shadow-sm bg-white"
                style={{ borderRadius: '0px' }}
              >
                {team.badgeUrl ? (
                  <img
